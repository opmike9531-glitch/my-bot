...
# --- STYLES (Fixed Overlap & Deep Pink Glow) ---
STYLE = """
<style>
    ...
    .card { background: #080808; padding: 40px; border-radius: 24px; text-align: center; box-shadow: 0 0 50px rgba(255, 20, 147, 0.2); width: 90%; max-width: 420px; border: 1px solid #1a1a1a; position: relative; box-sizing: border-box; }
    h1 span, h2 { color: #ff1493; text-shadow: 0 0 15px rgba(255, 20, 147, 0.7); font-weight: 800; margin-bottom: 20px; }
    .step { background: #111; padding: 15px; border-radius: 12px; margin: 12px 0; text-align: left; border-left: 4px solid #ff1493; font-size: 14px; line-height: 1.4; width: 100%; box-sizing: border-box; }
    ...
    /* FIXED OVERLAP: Added margin-bottom and clear width rules */
    .btn-glow { background: #ff1493; color: white; padding: 14px; border-radius: 30px; font-weight: bold; text-decoration: none; border:none; width: 100%; cursor: pointer; text-transform: uppercase; display: block; box-shadow: 0 0 20px rgba(255, 20, 147, 0.4); transition: 0.2s; margin-top: 20px; box-sizing: border-box; }
...
def reset_request():
    ...
    <html><head>{STYLE}</head><body>
        <div class="card">
            ...
            <p style="color: #666; font-size: 12px; margin-bottom: 20px;">Choose your new password to reset all sessions.</p>
